...
;;; *VERTEX-SHADER* and *FRAGMENT-SHADER* come from renderer-gl-shaders.lisp on the
;;; desktop and renderer-gl-shaders-es.lisp on Android, chosen by :IF-FEATURE in
;;; descendant.asd. Nothing below cares which: the uniforms, the texture formats and the
;;; arithmetic are the same, and only the dialect differs.
